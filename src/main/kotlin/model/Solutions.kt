    ...
    object World2 {
        ...
        val level2_7 = setOf(
            buildBoard(rows = 5) {
                ...
                row(HorizontalTrack(fixed = true), UpLeftDownFork(), Empty, HorizontalTrack(fixed = true), UpLeftTurn(), DownRightTurn(), EndingTrack)
            ...
            buildBoard(rows = 5) {
                ...
                row(HorizontalTrack(fixed = true), DownLeftUpFork(), Empty, HorizontalTrack(fixed = true), DownLeftTurn(), UpRightTurn(), EndingTrack)
                row(Empty, VerticalTrack(), Empty, Empty, VerticalTrack(), Empty, Empty)
                row(Empty, UpTunnel(BROWN, CarPosition(0, 4, DOWN)), Empty, Empty, UpTunnel(GRAY, CarPosition(0, 1, DOWN)), Empty, Empty)
            }
        )
        ...
        val level2_8 = setOf(
            buildBoard(rows = 6) {
                ...
                row(HorizontalTrack(fixed = true), UpLeftDownFork(), RightTunnel(GRAY, CarPosition(5, 0, RIGHT)), UpLeftTurn(), DownRightTurn(), HorizontalTrack(fixed = true))
        ...
        val level2_9 = setOf(
            buildBoard(rows = 8) {
                ...
                row(RightTunnel(GRAY, CarPosition(7, 4, LEFT)), HorizontalTrack(), HorizontalTrack(), HorizontalTrack(fixed = true), HorizontalTrack(), HorizontalTrack(), HorizontalTrack(), EndingTrack)
                row(Empty, Empty, Empty, Empty, Empty, Empty, Empty, Empty)
